...
type Report = { year:number; totalInvoiced:number; totalPaid:number; outstanding:number; overdue:number; cash:number; invoiceCount:number; month:{month:number;invoiced:number;paid:number}[] };
...
export default function PrehledyPage() {
  ...
  return <AppShell><div className="content">
    ...
    {report&&<><section className="stats-grid">
      ...
      <div className="stat-card"><span>Uhrazeno</span><strong>{report.totalPaid.toLocaleString("cs-CZ",{minimumFractionDigits:2})} Kč</strong><small>evidované úhrady</small></div>
